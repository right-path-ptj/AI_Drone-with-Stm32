...
#define AI_NETWORK_MODEL_SIGNATURE     "0xfbf192f9e208a3e82dee9079a651f38d"
...
#define AI_TOOLS_DATE_TIME   "2026-02-08T21:55:54+0900"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  2, 0x0,
  AI_SHAPE_INIT(4, 3, 32, 1, 1), AI_STRIDE_INIT(4, 4, 12, 384, 384),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 2828, 1, 1),
    2828, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    serving_default_keras_tensor0_output_array.data = AI_PTR(g_network_activations_map[0] + 52);
    serving_default_keras_tensor0_output_array.data_start = AI_PTR(g_network_activations_map[0] + 52);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    gemm_0_bias_array.data = AI_PTR(g_network_weights_map[0] + 384);
    gemm_0_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 384);
    gemm_1_weights_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_weights_array.data = AI_PTR(g_network_weights_map[0] + 512);
    gemm_1_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 512);
    gemm_1_bias_array.format |= AI_FMT_FLAG_CONST;
    gemm_1_bias_array.data = AI_PTR(g_network_weights_map[0] + 2560);
    gemm_1_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 2560);
    ...
    gemm_2_bias_array.data = AI_PTR(g_network_weights_map[0] + 2816);
    gemm_2_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 2816);
    return true;
  }
